...
const MyStories = () => {
  ...
  useEffect(async () => {
    await processGetPublishedStoriesAsync(dispatch, publishedStoriesPage, 'personal');
    formatPaginationMeta();
    setIsLoadingPage(false);
  }, [publishedStoriesPage]);

  useEffect(async () => {
    await processGetChatStoryDraftAsync(dispatch, draftStoriesPage, 'personal');
    formatPaginationMeta();
    setIsLoadingPage(false);
  }, [draftStoriesPage]);

  useEffect(async () => {
    await processGetInReviewStoriesAsync(dispatch, reviewsStoriesPage, 'personal');
    formatPaginationMeta();
    setIsLoadingPage(false);
  }, [reviewsStoriesPage]);
  ...
  return (
    <DefaultLayout>
      <PageHeader title='My Stories' subtitle=''>
        <Button
          type='button'
