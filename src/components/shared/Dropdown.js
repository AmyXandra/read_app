...
import { ChevronDownIcon, PencilAltIcon, TrashIcon, EyeIcon } from '@heroicons/react/solid';
      ...
      {({ open }) => (
        <>
          ...
          >
            <Menu.Items
              static
              className='origin-top-right z-10 absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none'
            >
